...
class fc_model(nn.Module):
    ...
    def __init__(self, len_max_molec1Hot, n_heads, num_of_neurons_layer1,
        ...
        self.linear6 = nn.Linear(399, 500)
        self.linear7 = nn.Linear(500, 250)
        self.linear8 = nn.Linear(250, 1)
...
if __name__ == '__main__':
    ...
    directory = change_str('dream_results/residual_stacked_lin_{}_{}_{}_{}/{}/{}' \
